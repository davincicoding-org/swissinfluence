...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AwardCategories".
 */
export type AwardCategories =
  | {
      category: number | Category;
      sponsor?: (number | null) | Brand;
      votingType: 'DEFAULT' | 'CUSTOM' | 'DISABLED';
      /**
       * If left empty, the default opening date of the award will be used.
       */
      votingOpeningOverride?: string | null;
      /**
...
export interface AwardsSelect<T extends boolean = true> {
  ...
  categories?: T | AwardCategoriesSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "AwardCategories_select".
 */
export interface AwardCategoriesSelect<T extends boolean = true> {
  category?: T;
  sponsor?: T;
  votingType?: T;
  votingOpeningOverride?: T;
  votingDeadlineOverride?: T;
  ranked?: T;
  winnerImage?: T;
  nominees?:
    | T
